...
<section class="hero-home2 pb100-xs">
      <div class="container">
        <div class="row mb60 mb0-xl">
          ...
          <div class="col-xl-5 d-none d-xl-block position-relative">
            <img src="<?= base_url('assets/images/')?>about/about-1.png" alt="" class="animate-up-1 main-img-home2">
            <div class="home2-hero-content position-relative">
              ...
              <img src="<?= base_url('assets/images/')?>about/happy-client.png" alt="" class="bounce-x bdrs16 img-1 default-box-shadow4">
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="tab-pane fade fz15 text show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <div class="row">
                    <div class="col-sm-6 col-xl-3">
                      <div class="listing-style1 bdrs16">
                        <div class="list-thumb">
                          <img class="w-100" src="<?= base_url('assets/images/')?>listings/g-1.jpg" alt="">
                          ...
                          <div class="list-meta d-flex justify-content-between align-items-center mt15">
                            <a class="d-flex" href="#">
                              <span class="position-relative mr10">
                                <img class="rounded-circle wa" src="<?= base_url('assets/images/')?>team/fl-s-1.png" alt="Freelancer Photo">
                      ...
                      <div class="listing-style1 bdrs16">
                        <div class="list-thumb">
                          <img class="w-100" src="<?= base_url('assets/images/')?>listings/g-5.jpg" alt="">
                          <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                        </div>
                        <div class="list-content">
                          <p class="list-text body-color fz14 mb-1">Web & App Design</p>
                          ...
                          <div class="list-meta d-flex justify-content-between align-items-center mt15">
                            <a class="d-flex" href="#">
                              <span class="position-relative mr10">
                                <img class="rounded-circle" src="<?= base_url('assets/images/')?>team/fl-s-1.png" alt="Freelancer Photo">
                                <span class="online-badges"></span>
                              </span>
                              <span class="fz14">Wanda Runo</span>
                            </a>
                    ...
                    <div class="col-sm-6 col-xl-3">
                      <div class="listing-style1 default-box-shadow1 bdrs16">
                        <div class="list-thumb">
                          <div class="listing-thumbIn-slider position-relative navi_pagi_bottom_center slider-1-grid owl-carousel owl-theme">
                            <div class="item">
                              <img class="w-100" src="<?= base_url('assets/images/')?>listings/g-2.jpg" alt="">
                              <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                            </div>
                            <div class="item">
                              <img class="w-100" src="<?= base_url('assets/images/')?>listings/g-3.jpg" alt="">
                              <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                            </div>
                            <div class="item">
                              <img class="w-100" src="<?= base_url('assets/images/')?>listings/g-4.jpg" alt="">
                              <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                            </div>
                            <div class="item">
                              <img class="w-100" src="<?= base_url('assets/images/')?>listings/g-5.jpg" alt="">
                        ...
                        <div class="list-content">
                          ...
                          <div class="list-meta d-flex justify-content-between align-items-center mt15">
                            <a href="#">
                              <span class="position-relative mr10">
                                <img class="rounded-circle" src="<?= base_url('assets/images/')?>team/fl-s-2.png" alt="Freelancer Photo">
                      ...
                      <div class="listing-style1 bdrs16">
                        <div class="list-thumb">
                          <img class="w-100" src="<?= base_url('assets/images/')?>listings/g-6.jpg" alt="">
                          <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                        </div>
                        <div class="list-content">
                          <p class="list-text body-color fz14 mb-1">Web & App Design</p>
                    ...
                    <div class="col-sm-6 col-xl-3">
                      <div class="listing-style1 bdrs16">
                        ...
                        <div class="list-content">
                          ...
                          <div class="list-meta d-flex justify-content-between align-items-center mt15">
                            <a class="d-flex" href="#">
                              <span class="position-relative mr10">
                                <img class="rounded-circle" src="<?= base_url('assets/images/')?>team/fl-s-3.png" alt="Freelancer Photo">
                                <span class="online-badges"></span>
                              </span>
                              <span class="fz14">Wanda Runo</span>
                            </a>
                      ...
                      <div class="listing-style1 bdrs16">
                        <div class="list-thumb">
                          <img class="w-100" src="<?= base_url('assets/images/')?>listings/g-7.jpg" alt="">
                          <a href="#" class="listing-fav fz12"><span class="far fa-heart"></span></a>
                        </div>
                        <div class="list-content">
                          <p class="list-text body-color fz14 mb-1">Design & Creative</p>
                      ...
                      <div class="listing-style1 bdrs16">
                        ...
                        <div class="list-content">
                          ...
                          <div class="list-meta d-flex justify-content-between align-items-center mt15">
                            <a class="d-flex" href="#">
                              <span class="position-relative mr10">
                                <img class="rounded-circle" src="<?= base_url('assets/images/')?>team/fl-s-4.png" alt="Freelancer Photo">
                                <span class="online-badges"></span>
                              </span>
                              <span class="fz14">Wanda Runo</span>
                            </a>
    ...
    <section class="cta-banner-about2 before-none at-home2 position-relative py-0">
      ...
      <img class="home2-cta-img" src="<?= base_url('assets/images/')?>about/about-10.jpg" alt="">
    </section>
      ...
      <div class="container">
        ...
        <div class="row wow fadeInUp">
          <div class="col-6 col-md-4 col-xl-2">
            <div class="partner_item text-center mb30-lg"><img class="wa m-auto" src="<?= base_url('assets/images/')?>partners/1.png" alt="1.png"></div>
          </div>
          <div class="col-6 col-md-4 col-xl-2">
            <div class="partner_item text-center mb30-lg"><img class="wa m-auto" src="<?= base_url('assets/images/')?>partners/2.png" alt="2.png"></div>
          </div>
          <div class="col-6 col-md-4 col-xl-2">
            <div class="partner_item text-center mb30-lg"><img class="wa m-auto" src="<?= base_url('assets/images/')?>partners/3.png" alt="3.png"></div>
          </div>
          <div class="col-6 col-md-4 col-xl-2">
            <div class="partner_item text-center mb30-lg"><img class="wa m-auto" src="<?= base_url('assets/images/')?>partners/4.png" alt="4.png"></div>
          </div>
          <div class="col-6 col-md-4 col-xl-2">
            <div class="partner_item text-center mb30-lg"><img class="wa m-auto" src="<?= base_url('assets/images/')?>partners/5.png" alt="5.png"></div>
          </div>
          <div class="col-6 col-md-4 col-xl-2">
            <div class="partner_item text-center mb30-lg"><img class="wa m-auto" src="<?= base_url('assets/images/')?>partners/6.png" alt="6.png"></div>
          </div>
        </div>
      </div>
    </section>
            ...
            <div class="dots_none slider-dib-sm slider-5-grid vam_nav_style owl-theme owl-carousel">
              <div class="item">
                <div class="feature-style1 mb30 bdrs16">
                  <div class="feature-img bdrs16 overflow-hidden"><img class="w-100" src="<?= base_url('assets/images/')?>listings/category-1.jpg" alt=""></div>
              ...
              <div class="item">
                <div class="feature-style1 mb30 bdrs16">
                  <div class="feature-img bdrs16 overflow-hidden"><img class="w-100" src="<?= base_url('assets/images/')?>listings/category-2.jpg" alt=""></div>
                  <div class="feature-content">
                    <div class="top-area">
                      <h6 class="title mb-1">1.853 skills</h6>
              ...
              <div class="item">
                <div class="feature-style1 mb30 bdrs16">
                  <div class="feature-img bdrs16 overflow-hidden"><img class="w-100" src="<?= base_url('assets/images/')?>listings/category-3.jpg" alt=""></div>
                  <div class="feature-content">
                    <div class="top-area">
                      <h6 class="title mb-1">1.853 skills</h6>
              ...
              <div class="item">
                <div class="feature-style1 mb30 bdrs16">
                  <div class="feature-img bdrs16 overflow-hidden"><img class="w-100" src="<?= base_url('assets/images/')?>listings/category-4.jpg" alt=""></div>
                  <div class="feature-content">
                    <div class="top-area">
                      <h6 class="title mb-1">1.853 skills</h6>
              ...
              <div class="item">
                <div class="feature-style1 mb30 bdrs16">
                  <div class="feature-img bdrs16 overflow-hidden"><img class="w-100" src="<?= base_url('assets/images/')?>listings/category-5.jpg" alt=""></div>
                  <div class="feature-content">
                    <div class="top-area">
                      <h6 class="title mb-1">1.853 skills</h6>
          ...
          <div class="col-lg-12">
            <div class="navi_pagi_bottom_center slider-4-grid owl-carousel owl-theme">
              <div class="item">
                <div class="freelancer-style1 text-center bdr1 hover-box-shadow mb60 bdrs16">
                  <div class="thumb w90 mb25 mx-auto position-relative rounded-circle">
                    <img class="rounded-circle mx-auto" src="<?= base_url('assets/images/')?>team/fl-1.png" alt="">
              ...
              <div class="item">
                <div class="freelancer-style1 text-center bdr1 hover-box-shadow mb60 bdrs16">
                  <div class="thumb w90 mb25 mx-auto position-relative rounded-circle">
                    <img class="rounded-circle mx-auto" src="<?= base_url('assets/images/')?>team/fl-2.png" alt="">
                    <span class="online"></span>
                  </div>
                  <div class="details">
              ...
              <div class="item">
                <div class="freelancer-style1 text-center bdr1 hover-box-shadow mb60 bdrs16">
                  <div class="thumb w90 mb25 mx-auto position-relative rounded-circle">
                    <img class="rounded-circle mx-auto" src="<?= base_url('assets/images/')?>team/fl-3.png" alt="">
                    <span class="online"></span>
                  </div>
                  <div class="details">
              ...
              <div class="item">
                <div class="freelancer-style1 text-center bdr1 hover-box-shadow mb60 bdrs16">
                  <div class="thumb w90 mb25 mx-auto position-relative rounded-circle">
                    <img class="rounded-circle mx-auto" src="<?= base_url('assets/images/')?>team/fl-4.png" alt="">
                    <span class="online"></span>
                  </div>
                  <div class="details">
            ...
            <div class="testimonial-slider2 mb15 navi_pagi_bottom_center slider-1-grid owl-carousel owl-theme wow fadeInUp" data-wow-delay="300ms">
                ...
                <div class="testimonial-style1 default-box-shadow1 position-relative bdrs16 mb35">
                  ...
                  <div class="thumb d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="wa" src="<?= base_url('assets/images/')?>testimonials/testimonial-1.png" alt="">
                    </div>
              ...
              <div class="item">
                <div class="testimonial-style1 default-box-shadow1 position-relative bdrs16 mb35">
                  ...
                  <div class="thumb d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="wa" src="<?= base_url('assets/images/')?>testimonials/testimonial-2.png" alt="">
                    </div>
                    <div class="flex-grow-1 ms-3">
                      <h6 class="mb-0">Courtney Henry</h6>
                      <p class="fz14 mb-0">Web Designer</p>
              ...
              <div class="item">
                <div class="testimonial-style1 default-box-shadow1 position-relative bdrs16 mb35">
                  ...
                  <div class="thumb d-flex align-items-center">
                    <div class="flex-shrink-0">
                      <img class="wa" src="<?= base_url('assets/images/')?>testimonials/testimonial-3.png" alt="">
                    </div>
                    <div class="flex-grow-1 ms-3">
                      <h6 class="mb-0">Courtney Henry</h6>
                      <p class="fz14 mb-0">Web Designer</p>
