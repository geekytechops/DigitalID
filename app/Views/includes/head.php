...
<link rel="stylesheet" href="<?= base_url('assets/css/ace-responsive-menu.css') ?>">
...
<link rel="stylesheet" href="<?= base_url('assets/css/style.css') ?>"><link rel="stylesheet" href="<?= base_url('assets/css/ud-custom-spacing.css') ?>">
